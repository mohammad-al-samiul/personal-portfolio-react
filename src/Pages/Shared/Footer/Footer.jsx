...
function Footer() {
  return (
    <div className="lg:flex mt-10 bg-[#fff8f3] p-6 lg:p-16">
      ...
      <div className="lg:w-1/2 lg:px-4 lg:ml-20 ">
        <h2 className="text-3xl font-bold mb-6 mt-10 lg:mt-0">Let's Message me</h2>
        <form action="">
          <div>
            <input
              type="text"
          ...
          <div>
            <button type="submit" className="w-full max-w-xs bg-red-400 text-white px-2 py-2 rounded-md focus:bg-red-500">
              Submit
            </button>
          </div>
        </form>
